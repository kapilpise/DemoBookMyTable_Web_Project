BookMyTableApp.controller('ManagerEditOrderCtrl', function ($scope, $http, $location, $timeout, $routeParams, toaster) {
    ...
    $scope.UpdateMyOrder = function (PlaceOrderform)
    {
        ...
        EditOrderDetails.UserType = "Manager";
        ...
        $http({
            ...
            //url: "http://localhost:52530/api/Hotel/UpdateExistingOrder",
            dataType: 'json',
            method: 'POST',
    ...
    $scope.CancelMyOrder = function () {
        var data = { OrderId: $scope.OrderID, UserType: "Manager"}
        $http({
